  ...
  return (
    <Wrapper>
      <div className="privacypolicypage_parentContainer mt-32">
        ...
        <p className="text-lg offGray mt-12 italic">Updated on: Aug 15, 2022</p>
        <p className="text-xl offGray mt-12">
          ...
          associated with that data. The Privacy Policy for nurdsoft has been
          created with the help of Terms Feed. We use your data to provide and
        ...
        <div className="privacypolicypage_cookiesDataUsage mt-20">
          ...
          <h4 className="white mt-8 text-3xl m-0 font-medium">Use of Data</h4>
          ...
          <ul className="mt-8">
            {useOfDataList.map((data: string, index: number) => {
              return (
                <li key={index} className="text-xl offGray mt-2 font-normal">
        ...
        >
          <h4 className="privacypolicypage_disclosureOfDataTitle white leading-normal text-6xl m-0 font-medium">
            Disclosure Of Data
          </h4>
          ...
          <p className="text-xl offGray mt-8 italic font-normal">
            Nurdsoft may disclose your Personal Data in the good faith belief
        ...
        >
          <h4 className="privacypolicypage_securityOfDataTitle white leading-normal text-6xl m-0 font-medium">
            Security Of Data
          </h4>
          <p className="text-xl offGray mt-8 font-normal">
